...
# LCM
BOOT_LOGO = c767_otd_l6202l_39_o1_fwvgaplus
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
LCM_HEIGHT = 996
LCM_WIDTH = 480
...
# CAMERA HAL KERNEL
CUSTOM_HAL_IMGSENSOR = sp5509_mipi_raw sp2609_mipi_raw gc6133_mipi_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = sp5509_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_IMGSENSOR = sp2609_mipi_raw
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN2_IMGSENSOR = gc6133_mipi_yuv
CUSTOM_HAL_CAM_CAL =

CUSTOM_KERNEL_IMGSENSOR = sp5509_mipi_raw sp2609_mipi_raw gc6133_mipi_yuv
CUSTOM_KERNEL_MAIN_IMGSENSOR = sp5509_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_IMGSENSOR = sp2609_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc6133_mipi_yuv
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_CAM_CAL =
ODM_FEATURE_FAKE_MAIN2_CAMERA_SUPPORT = yes

# AF LENS HAL KERNEL
CUSTOM_HAL_LENS = fm50af dummy_lens dw9714af dw9763af
CUSTOM_HAL_MAIN_LENS = fm50af dw9714af dw9763af
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_HAL_SUB_BACKUP_LENS = 

CUSTOM_KERNEL_LENS = fm50af dummy_lens dw9714af dw9763af
CUSTOM_KERNEL_MAIN_LENS = fm50af dw9714af dw9763af
...
FINGERPRINT_MICROARRAY_MICROTRUST_TEE=yes
MICROARRAY_CHIP_SELECT = N64_N48
#FINGERPRINT_SUNWAVE_SW531B_REE = yes
#FINGERPRINT_MICROARRAY_E064N_REE_CUSTOM = yes
#FINGERPRINT_MICROARRAY_E064N_REE is not set
#WTK End For Driver--------------------------------------------------------------------------------
#Begin For Common----------------------------------------------------------{

WTK_BUILD_VERNO = LEAGOO_M11_OS3.0_181009
WTK_INTERNAL_BUILD_VERNO = C767_OTD_L6202L_39_O1_V0.5.4_181101

#add by xiangxiang.guo for TBSW-308 20180201 start
WTK_TARGET_BOARD_NAME = C767
WTK_MTP_LABEL = M11
WTK_PTP_LABEL = M11
WTK_INTERNAL_SD_LABEL = M11
#add by xiangxiang.guo for TBSW-308 20180201 end
#A:TBSW-74 xiangxiang.guo 20180123 {
WTK_STRESS_TEST = yes
#A:TBSW-74 }

#add by yangyin for TBSW-62 start
WTK_FILEMANAGER_APP = no 
#add by yangyin for TBSW-62 end
#End For Common------------------------------------------------------------}

#add by wuzhi.peng for TBSW-53 start 
WTK_LED_SETTING = yes
#add by wuzhi.peng for TBSW-53 end
#add wtk camera---------------------------------
GANGYUN_BOKEH_SUPPORT = yes
GANGYUN_CAMERA_BEAUTY = yes
GANGYUN_CAMERA_BEAUTY_HWD = yes
WTK_CAMERA_SUPPORT = yes
#add wtkcamera----------------------------------

#add by luojunlin for BUG_ID:TBSW-421 20180208 (start)
MTK_BOOT_ANIMATION_SOUND_SUPPORT = yes
#add by luojunlin for BUG_ID:TBSW-421 20180208 (end)
#WTK_SNAPSHOT_SUPPORT = yes
FACE_COOL_SUPPORT = no
...
#add YWLL-36 xudong.zhang 20180510(start)
CUSTOM_OTD_RINGTONES = yes
WTK_MULTISIM_RINGTONE_SUPPORT = yes
WTK_MULTISIM_MESSAGE_RINGTONE_SUPPORT = yes
#add YWLL-36 xudong.zhang 20180510(end)

WTK_APP_WAKE_GESTURE_SUPPORT = yes
#A by wuzhi.peng for guangsheng faceunlock
FACE_UNLOCK_SUPPORT = no
#A by wuzhi.peng for guangsheng faceunlock
#add by wuzhi.peng for livedisplay
WTK_LIVE_DISPLAY_SUPPORT = yes
#add by wuzhi.peng for livedisplay
#add BUG_ID:TBSW-554 zhangzhanbo 20180530 start
WTK_FINGERPRINT_LAUNCHER_APP = yes
#add BUG_ID:TBSW-554 zhangzhanbo 20180530 end
#add by guoyuegang for BUGID:TBSW-603 20180612 start 
WTK_MEMORY_SWITCH_SUPPORT = yes
#add by guoyuegang for BUGID:TBSW-603 20180612 end

#add bluetooh name
WTK_DEFAULT_BLUETOOTH_NAME = LEAGOO M11
#A:YWLL-30 jinhui.li {
WTK_CUSTOM_ECC_LIST = yes
#A:YWLL-30 }

#add by yangyin for fastpass+ start 
WTK_GMAIL_OVERRIDES_MTKEMAIL =yes
WTK_MESSAGE_OVERRIDES_MTKMMS =yes
WTK_CALENDAR_OVERRIDES_MTKCALENDAR =yes
WTK_PHOTOS_OVERRIDES_GALLERY2 =yes
#add by yangyin for fastpass+ end


#add BUG_ID:CQLQ-76 liuzhijun 20180815 (start)
WTK_LIUHAI_SCREEN_SUPPORT = yes
#add BUG_ID:CQLQ-76 liuzhijun 20180815 (end)

#add CQLQ-24 zhiheng.huang 20160826 start
PHOTO_TABLE_VIDEO_SUPPORT = yes
#add CQLQ-24 end

WTK_LATINIME_OVERRIDES_MTKLATINIME = yes
#A by wuzhi.peng for removemusic start
WTK_REMOVE_ODM_MUSIC=yes
#A by wuzhi.peng for removemusic

#add by chenxuanyu start
WTK_CAMERA_COVERED_SWITCH = yes
#add by chenxuanyu ends

#add gang.liu for cts start
CUSTOM_REMOVE_OPENWNN =yes
#add gang.liu for cts end

#add gang.liu CQYJ-846 start
WTK_BUILD_FINGERPRINT = LEAGOO/M11/M11:8.1.0/O11019/1539057076:user/release-keys
WTK_MOCK_DESC=M11-user 8.1.0 O11019 1539057076 release-keys
WTK_BUILD_INCREMENTAL=1539057076
#add gang.liu CQYJ-846 end

#debuid:YJLL-431 add by chenxuanyu start
TARGET_RECOVERY_UI_MARGIN_HEIGHT = 60
TARGET_RECOVERY_UI_MARGIN_WIDTH = 20
#debuid:YJLL-431 add by chenxuanyu end
