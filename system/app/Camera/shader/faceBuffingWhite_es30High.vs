...
void main()
{
    ...
    sampleColor += texture(aTexture0, location8);
    sampleColor += texture(aTexture0, location9);
    sampleColor += texture(aTexture0, location10);
    sampleColor += texture(aTexture0, location11);
    sampleColor /= 12.0;
