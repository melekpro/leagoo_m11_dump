...
# Generated at 2018-01-03 13:27:57
...
SIM_DRV_RETRY_3V_WHEN_SIM_RECOVERY = FALSE
  # Description:
...
3G_B5_AND_B19_INDICATOR_SUPPORT = FALSE
  # Description:
  #   Value:TRUE
  #   Description: Combine WCDMA Supported Band 5 and Band 19
  #   Value:FALSE 
  #   Description:Do not combine WCDMA Supported Band 5 and Band 19
  # Option Values:
...
DSP_FLAVOR = DEFAULT_ASIC_WO_LTEPOS
  # Description:
...
LTE_RF_MODULE = MT6739_LTE_MT6177M
  # Description:
...
MM_RF_MODULE = MT6739_MMRF_MT6177M
  # Description:
...
NSFT_ADJUST_TX_POWER_OFFSET_SUPPORT = FALSE
  # Description:
  #   Description:
...
WCDMA_R5_SETPOINT_DYNAMIC_BACKOFF = FALSE
  # Description:
  #   Value:TRUE
  #   Description: Dynamic backoff setpoint for R5 test sim case
  #   Value:FALSE
  #   Description: No setpoint backoff
  # Option Values:
  #   no: auto created - value no
  #   yes: auto created - value yes
  # Switch-ability:
...
WCDMA_R99_SETPOINT_DYNAMIC_BACKOFF = FALSE
  # Description:
  #   Value: TRUE
  #   Description: Dynamic backoff setpoint for R99 test sim case
  #   Value: FALSE
  #   Description: No setpoint backoff
  # Option Values:
  #   no: auto created - value no
...
AMMS_DRDI_SUPPORT = TRUE
  ...
  #   Note: customers cannot turn on &quot;modem secure boot check&quot; and &quot;AMMS-DRDI&quot; simultaneously
  # Option Values:
  #   FALSE: Disable this feature
  #   TRUE: Enable this feature
  # Switch-ability:
...
RF_MODULE = MT6739_2G_MT6177M_SP
  # Description:
...
UMTS_RF_MODULE = MT6739_UMTS_FDD_MT6177M
  # Description:
...
UMTS_TDD128_RF_MODULE = MT6739_UMTS_TDD_MT6177M
  # Description:
  #   Modem Capability
  # Option Values:
  #   NA: the RF module used in this project
...
ORIGINAL_VERNO = MOLY.LR12A.R2.MP.V19

SECURITY_FEATURE_TEST = FALSE

USE_EVS_IO_REPLACE_AWB = FALSE

WTK_RF_MODULE = C767

#VERNO = MOLY.LR12A.R2.MP.V10.6
VERNO = C767_39_O1_LWTG_V0.1.4_S181029
...
COM_DEFS_FOR_MT6739_2G_MT6177M_SP = MT6177M_2G_RF
COM_DEFS_FOR_MT6739_UMTS_FDD_MT6177M = MT6177M_RF MT6177M_UMTS_FDD
COM_DEFS_FOR_MT6739_UMTS_TDD_MT6177M = MT6177M_RF MT6177M_UMTS_TDD
COM_DEFS_FOR_MT6739_LTE_MT6177M = MT6177M_RF MT6177M_LTE_RF
...
# *************************************************************************
# Wheatek custom options penny add 140227 begin
# *************************************************************************
WHEATEK_PROJECT = C767_39_O1_LWTG
# *************************************************************************
# Wheatek custom options penny add 140227 end
# *************************************************************************
